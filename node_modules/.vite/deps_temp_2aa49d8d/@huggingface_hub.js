...
async function createApiError(response, opts) {
  var _a2;
  const error = new HubApiError(response.url, response.status, response.headers.get("X-Request-Id") ?? (opts == null ? void 0 : opts.requestId));
  ...
  const callbackRes = Promise.resolve().then(
    () => cb(
      (y) => {
        var _a2;
        addPromise();
        (_a2 = promises.at(-2)) == null ? void 0 : _a2.resolve({ done: false, value: y });
      },
      (r) => {
        var _a2;
        addPromise();
        (_a2 = promises.at(-2)) == null ? void 0 : _a2.resolve({ done: true, value: r });
      },
      (err) => {
        var _a2;
        return (_a2 = promises.shift()) == null ? void 0 : _a2.reject(err);
      }
    )
  ).catch((err) => {
    var _a2;
...
async function getWebWorkerCode() {
  const sha256Module = await import("./sha256-wrapper-RIVMC2TM-424MFA3I.js");
...
async function* sha256(buffer, opts) {
  ...
  if (buffer.size < maxCryptoSize && ((_a2 = globalThis.crypto) == null ? void 0 : _a2.subtle)) {
  ...
  if (isFrontend) {
        ...
        return yield* eventToGenerator((yieldCallback, returnCallback, rejectCallback) => {
          ...
          messageHandler = (event) => {
            ...
            if (event.data.sha256) {
              ...
              try {
                (_a4 = opts.abortSignal) == null ? void 0 : _a4.throwIfAborted();
              } catch (err) {
                cleanup();
          ...
          if (opts == null ? void 0 : opts.abortSignal) {
            ...
            const abortListener = () => {
              ...
              cleanup();
              destroyWorker(worker);
              rejectCallback(((_a4 = opts.abortSignal) == null ? void 0 : _a4.reason) ?? new DOMException("Aborted", "AbortError"));
              (_b2 = opts.abortSignal) == null ? void 0 : _b2.removeEventListener("abort", abortListener);
            };
    ...
    if (!wasmModule) {
      wasmModule = await import("./sha256-wrapper-RIVMC2TM-424MFA3I.js");
    }
  ...
  if (!cryptoModule) {
    cryptoModule = await import("./sha256-node-TNZ2WHTI-F6HLPQ6W.js");
  }
...
var WebBlob = class extends Blob {
  ...
  static async create(url, opts) {
    const customFetch = (opts == null ? void 0 : opts.fetch) ?? fetch;
    ...
    if (!supportRange || size < ((opts == null ? void 0 : opts.cacheBelow) ?? 1e6)) {
  ...
  stream() {
    ...
    this.fetchRange().then((response) => {
      var _a2;
      return (_a2 = response.body) == null ? void 0 : _a2.pipeThrough(stream);
...
async function createBlobs(url, destPath, opts) {
  ...
  if (url.protocol === "file:") {
    const { FileBlob } = await import("./FileBlob-7MRLQ6TG-3H427MXS.js");
    const { subPaths } = await import("./sub-paths-F6TP7MGR-3X2LXQXY.js");
...
var _XetBlob_instances, clone_fn, _reconstructionInfoPromise, loadReconstructionInfo_fn, fetch_fn, _a;
var XetBlob = (_a = class extends Blob {
  constructor(params) {
    super([]);
    __privateAdd(this, _XetBlob_instances);
    __publicField(this, "fetch");
    __publicField(this, "accessToken");
    __publicField(this, "refreshUrl");
    __publicField(this, "reconstructionUrl");
    __publicField(this, "hash");
    __publicField(this, "start", 0);
    __publicField(this, "end", 0);
    __publicField(this, "internalLogging", false);
    __publicField(this, "reconstructionInfo");
    __publicField(this, "listener");
    __privateAdd(this, _reconstructionInfoPromise);
  ...
  slice(start = 0, end = this.size) {
    ...
    const slice = __privateMethod(this, _XetBlob_instances, clone_fn).call(this);
  ...
  async arrayBuffer() {
    const result = await __privateMethod(this, _XetBlob_instances, fetch_fn).call(this);
  ...
  stream() {
    const stream = new TransformStream();
    __privateMethod(this, _XetBlob_instances, fetch_fn).call(this).then((response) => response.pipeThrough(stream)).catch((error) => stream.writable.abort(error.message));
    return stream.readable;
  }
}, _XetBlob_instances = new WeakSet(), clone_fn = function() {
  ...
  return blob;
}, _reconstructionInfoPromise = new WeakMap(), loadReconstructionInfo_fn = function() {
  if (__privateGet(this, _reconstructionInfoPromise)) {
    return __privateGet(this, _reconstructionInfoPromise);
  }
  __privateSet(this, _reconstructionInfoPromise, (async () => {
  ...
  })().finally(() => __privateSet(this, _reconstructionInfoPromise, void 0)));
  return __privateGet(this, _reconstructionInfoPromise);
}, fetch_fn = async function() {
  if (!this.reconstructionInfo) {
    await __privateMethod(this, _XetBlob_instances, loadReconstructionInfo_fn).call(this);
  }
    ...
    for (const term of reconstructionInfo.terms) {
      ...
      fetchData:
        while (!done && totalBytesRead < maxBytes) {
          ...
          while (totalBytesRead < maxBytes && ((_c = result.value) == null ? void 0 : _c.byteLength)) {
            ...
            let uncompressed = chunkHeader.compression_scheme === 1 ? decompress(result.value.slice(0, chunkHeader.compressed_length), chunkHeader.uncompressed_length) : chunkHeader.compression_scheme === 2 ? bg4_regroup_bytes(
              decompress(
  ...
  const iterator = readData(
    ...
    this.fetch,
    this.end - this.start,
    __privateMethod(this, _XetBlob_instances, loadReconstructionInfo_fn).bind(this)
  );
...
var SplicedBlob = class extends Blob {
  constructor(originalBlob, spliceOperations) {
    super();
    __publicField(this, "originalBlob");
    __publicField(this, "spliceOperations");
  ...
  get firstSpliceIndex() {
    var _a2;
    return ((_a2 = this.spliceOperations[0]) == null ? void 0 : _a2.start) ?? Infinity;
  }
  /**
...
var CurrentXorbInfo = class {
  constructor() {
    ...
    __publicField(this, "fileProcessedBytes");
    __publicField(this, "fileUploadedBytes");
    __publicField(this, "fileSize");
    __publicField(this, "data");
    __publicField(this, "immutableData");
    this.id = 0;
    this.offset = 0;
    this.chunks = [];
...
async function* createXorbs(fileSources, params) {
  ...
  const chunkModule = await import("./chunker_wasm-3YGRTTMN-AEFB4ZIQ.js");
  let xorbId = 0;
  ...
  for await (const fileSource of fileSources) {
    (_a2 = params.yieldCallback) == null ? void 0 : _a2.call(params, {
      event: "fileProgress",
      path: fileSource.path,
      progress: 0
    });
    if (alreadyDoneFileSha256s.has(fileSource.sha256)) {
      (_b = params.yieldCallback) == null ? void 0 : _b.call(params, {
        event: "fileProgress",
        path: fileSource.path,
        progress: 1
      });
      ...
      const addChunks = async function* (chunks) {
        ...
        for (const chunk2 of chunks) {
          ...
          if (cacheData === void 0 && chunk2.dedup && bytesSinceRemoteDedup >= INTERVAL_BETWEEN_REMOTE_DEDUP) {
            ...
            if (shardResp.ok) {
              ...
              if (dedupedBytes > oldDedupedBytes) {
                (_a3 = xorb.fileUploadedBytes)[_b2 = fileSource.path] ?? (_a3[_b2] = 0);
          ...
          if (cacheData === void 0) {
            ...
            (_c = xorb.fileUploadedBytes)[_d = fileSource.path] ?? (_c[_d] = 0);
          ...
          if (bytesSinceLastProgressEvent >= 1e6) {
            ...
            (_e = params.yieldCallback) == null ? void 0 : _e.call(params, {
              event: "fileProgress",
              path: fileSource.path,
...
function backtrackDedup(xorb, computeHmac, shardData, chunkCache, chunkMetadata, dedupedBytes) {
  ...
  for (let chunkToRecheckIndex = ((_a2 = xorb.immutableData) == null ? void 0 : _a2.chunkIndex) ?? 0; chunkToRecheckIndex < xorb.chunks.length; chunkToRecheckIndex++) {
...
function writeChunk(xorb, chunk2, hash2) {
  ...
  xorb.data[xorb.offset + 4] = chunkToWrite.length < chunk2.length ? bgCompressedChunk.length < regularCompressedChunk.length ? 2 : 1 : 0;
  ...
  try {
    ...
    const processChunks = async (chunkData) => {
      for (const chunk2 of chunkData) {
        chunksProcessed++;
        if ((opts == null ? void 0 : opts.isAtBeginning) && chunksProcessed === 1) {
          chunk2.dedup = true;
        }
    ...
    while (true) {
      if ((opts == null ? void 0 : opts.end) !== void 0 && totalBytes >= opts.end) {
        break;
      }
      if ((opts == null ? void 0 : opts.maxChunks) !== void 0 && chunksProcessed >= opts.maxChunks) {
        break;
      }
      const { done, value } = await reader.read();
      if (done) {
...
async function* commitIter(params) {
  ...
  try {
    ...
    const gitAttributes = (_a2 = allOperations.filter(isFileOperation).find((op) => op.path === ".gitattributes")) == null ? void 0 : _a2.content;
    ...
    for (const operations of chunk(
      ...
      if (useXet) {
        for (const obj of json.objects) {
          ...
          if (!((_b = obj.actions) == null ? void 0 : _b.upload)) {
            yield {
              event: "fileProgress",
              path: op.path,
              progress: 1,
        ...
        const source = async function* () {
          ...
          for (const obj of json.objects) {
            const op = shaToOperation.get(obj.oid);
            if (!op || !((_a3 = obj.actions) == null ? void 0 : _a3.upload)) {
              continue;
            }
            abortSignal == null ? void 0 : abortSignal.throwIfAborted();
        ...
        yield* eventToGenerator((yieldCallback, returnCallback, rejectCallback) => {
          return promisesQueueStreaming(
            json.objects.map((obj) => async () => {
              ...
              if (!((_a3 = obj.actions) == null ? void 0 : _a3.upload)) {
                yieldCallback({
                  event: "fileProgress",
                  path: op.path,
                  progress: 1,
...
async function* listDatasets(params) {
  var _a2, _b, _c, _d, _e;
  const accessToken = params && checkCredentials(params);
  let totalToFetch = (params == null ? void 0 : params.limit) ?? Infinity;
  const search = new URLSearchParams([
    ...Object.entries({
      limit: String(Math.min(totalToFetch, 500)),
      ...((_a2 = params == null ? void 0 : params.search) == null ? void 0 : _a2.owner) ? { author: params.search.owner } : void 0,
      ...((_b = params == null ? void 0 : params.search) == null ? void 0 : _b.query) ? { search: params.search.query } : void 0
    }),
    ...((_d = (_c = params == null ? void 0 : params.search) == null ? void 0 : _c.tags) == null ? void 0 : _d.map((tag) => ["filter", tag])) ?? [],
    ...DATASET_EXPAND_KEYS.map((val) => ["expand", val]),
    ...((_e = params == null ? void 0 : params.additionalFields) == null ? void 0 : _e.map((val) => ["expand", val])) ?? []
  ]).toString();
  let url = `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/datasets` + (search ? "?" + search : "");
  while (url) {
    const res = await ((params == null ? void 0 : params.fetch) ?? fetch)(url, {
      headers: {
...
async function datasetInfo(params) {
  ...
  const search = new URLSearchParams([
    ...DATASET_EXPAND_KEYS.map((val) => ["expand", val]),
    ...((_a2 = params == null ? void 0 : params.additionalFields) == null ? void 0 : _a2.map((val) => ["expand", val])) ?? []
  ]).toString();
...
async function fileDownloadInfo(params) {
  ...
  let size;
  let xetInfo;
  if ((_a2 = resp.headers.get("Content-Type")) == null ? void 0 : _a2.includes("application/vnd.xet-fileinfo+json")) {
  ...
  return {
    ...
    url: resp.url && (new URL(resp.url).origin === new URL(hubUrl).origin || ((_b = resp.headers.get("X-Cache")) == null ? void 0 : _b.endsWith(" cloudfront"))) ? resp.url : url
  };
}
...
async function* listModels(params) {
  ...
  const search = new URLSearchParams([
    ...Object.entries({
      ...
      ...((_d = params == null ? void 0 : params.search) == null ? void 0 : _d.inferenceProviders) ? { inference_provider: params.search.inferenceProviders.join(",") } : void 0
    }),
    ...((_f = (_e = params == null ? void 0 : params.search) == null ? void 0 : _e.tags) == null ? void 0 : _f.map((tag) => ["filter", tag])) ?? [],
    ...MODEL_EXPAND_KEYS.map((val) => ["expand", val]),
    ...((_g = params == null ? void 0 : params.additionalFields) == null ? void 0 : _g.map((val) => ["expand", val])) ?? []
  ]).toString();
  ...
  while (url) {
    ...
    for (const item of items) {
      ...
      if (((_h = params == null ? void 0 : params.additionalFields) == null ? void 0 : _h.includes("inferenceProviderMapping")) && item.inferenceProviderMapping) {
...
async function* listSpaces(params) {
  ...
  const search = new URLSearchParams([
    ...
    ...((_d = (_c = params == null ? void 0 : params.search) == null ? void 0 : _c.tags) == null ? void 0 : _d.map((tag) => ["filter", tag])) ?? [],
    ...[...SPACE_EXPAND_KEYS, ...(params == null ? void 0 : params.additionalFields) ?? []].map(
      (val) => ["expand", val]
    )
  ]).toString();
...
async function* listCollections(params) {
  ...
  if ((_a2 = params == null ? void 0 : params.search) == null ? void 0 : _a2.owner) {
    for (const owner of params.search.owner) {
      searchParams.append("owner", owner);
    }
  }
  if ((_b = params == null ? void 0 : params.search) == null ? void 0 : _b.item) {
    for (const item of params.search.item) {
      searchParams.append("item", item);
    }
  }
  if ((_c = params == null ? void 0 : params.search) == null ? void 0 : _c.q) {
...
async function modelInfo(params) {
  ...
  if (((_b = params == null ? void 0 : params.additionalFields) == null ? void 0 : _b.includes("inferenceProviderMapping")) && data.inferenceProviderMapping) {
...
async function oauthHandleRedirect(opts) {
  ...
  const redirectedUrl = (opts == null ? void 0 : opts.redirectedUrl) ?? window.location.href;
  const searchParams = (() => {
    try {
  ...
  const nonce = (opts == null ? void 0 : opts.nonce) ?? localStorage.getItem("huggingface.co:oauth:nonce");
  if (!code) {
  ...
  const codeVerifier = (opts == null ? void 0 : opts.codeVerifier) ?? localStorage.getItem("huggingface.co:oauth:code_verifier");
  if (!codeVerifier) {
...
async function oauthHandleRedirectIfPresent(opts) {
  ...
  const searchParams = new URLSearchParams((opts == null ? void 0 : opts.redirectedUrl) ?? window.location.search);
...
async function oauthLoginUrl(opts) {
  ...
  const variables = (
    ...
    typeof window !== "undefined" ? ((_a2 = window.huggingface) == null ? void 0 : _a2.variables) ?? null : null
  );
...
async function parseSafetensorsMetadata(params) {
  ...
  const quantConfig = modelConfig == null ? void 0 : modelConfig.quantization_config;
  if (params.path && RE_SAFETENSORS_FILE.test(params.path) || await fileExists({ ...params, path: SAFETENSORS_FILE })) {
    ...
    return {
      ...
      ...params.computeParametersCount ? {
        ...
        parameterTotal: (
          /// shortcut: get param count directly from metadata
          ((_a2 = index.metadata) == null ? void 0 : _a2.total_parameters) ? typeof index.metadata.total_parameters === "number" ? index.metadata.total_parameters : typeof index.metadata.total_parameters === "string" ? parseInt(index.metadata.total_parameters) : void 0 : void 0
        )
      } : void 0
    };
  } else {
...
function getQuantizationMultiplier(tensorName, dtype, quantConfig) {
  ...
  const quantMethod = (_a2 = quantConfig.quant_method) == null ? void 0 : _a2.toLowerCase();
  switch (quantMethod) {
    case "mxfp4":
...
async function whoAmI(params) {
  ...
  if (typeof ((_a2 = response.auth.accessToken) == null ? void 0 : _a2.createdAt) === "string") {
...
//# sourceMappingURL=@huggingface_hub.js.map
