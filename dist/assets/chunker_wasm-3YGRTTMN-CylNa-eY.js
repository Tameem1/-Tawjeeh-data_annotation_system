var e=Object.defineProperty,q=(A,I)=>{for(var g in I)e(A,g,{get:I[g],enumerable:!0})},S={};q(S,{Chunker:()=>p,__wbg_String_8f0eb39a4a4c2f66:()=>x,__wbg_buffer_609cc3eee51ed158:()=>j,__wbg_call_672a4d21634d4a24:()=>z,__wbg_done_769e5ede4b31c67b:()=>u,__wbg_get_67b2ba62fc30de12:()=>T,__wbg_get_b9b93047fe3cf45b:()=>v,__wbg_getwithrefkey_1dc361bd10053bfe:()=>O,__wbg_instanceof_ArrayBuffer_e14585432e3737fc:()=>_,__wbg_instanceof_Uint8Array_17156bcf118086a9:()=>P,__wbg_isArray_a1eab7e0d067391b:()=>$,__wbg_isSafeInteger_343e2beeeece1bb0:()=>AA,__wbg_iterator_9a24c88df860dc65:()=>IA,__wbg_length_a446193dc22c12f8:()=>gA,__wbg_length_e2d2a49132c1b256:()=>BA,__wbg_new_405e22f390576ce2:()=>QA,__wbg_new_78feb108b6472713:()=>CA,__wbg_new_a12002a7f91c75be:()=>EA,__wbg_next_25feadfc0913fea9:()=>iA,__wbg_next_6574e1a8a62d1055:()=>DA,__wbg_set_37837023f3d740e8:()=>wA,__wbg_set_3f1d0b984ed272ed:()=>oA,__wbg_set_65595bdd868b3009:()=>GA,__wbg_set_wasm:()=>H,__wbg_value_cd1ffa7b1ab794f1:()=>cA,__wbindgen_as_number:()=>NA,__wbindgen_boolean_get:()=>FA,__wbindgen_debug_string:()=>yA,__wbindgen_error_new:()=>hA,__wbindgen_in:()=>aA,__wbindgen_init_externref_table:()=>YA,__wbindgen_is_function:()=>MA,__wbindgen_is_object:()=>JA,__wbindgen_is_undefined:()=>RA,__wbindgen_jsval_loose_eq:()=>sA,__wbindgen_memory:()=>UA,__wbindgen_number_get:()=>kA,__wbindgen_number_new:()=>LA,__wbindgen_string_get:()=>SA,__wbindgen_string_new:()=>HA,__wbindgen_throw:()=>nA,compute_file_hash:()=>m,compute_hmac:()=>V,compute_verification_hash:()=>W,compute_xorb_hash:()=>Z});var C;function H(A){C=A}var w=0,Y=null;function y(){return(Y===null||Y.byteLength===0)&&(Y=new Uint8Array(C.memory.buffer)),Y}var b=typeof TextEncoder>"u"?(0,module.require)("util").TextEncoder:TextEncoder,M=new b("utf-8"),f=typeof M.encodeInto=="function"?function(A,I){return M.encodeInto(A,I)}:function(A,I){const g=M.encode(A);return I.set(g),{read:A.length,written:g.length}};function h(A,I,g){if(g===void 0){const D=M.encode(A),c=I(D.length,1)>>>0;return y().subarray(c,c+D.length).set(D),w=D.length,c}let B=A.length,Q=I(B,1)>>>0;const E=y();let i=0;for(;i<B;i++){const D=A.charCodeAt(i);if(D>127)break;E[Q+i]=D}if(i!==B){i!==0&&(A=A.slice(i)),Q=g(Q,B,B=i+A.length*3,1)>>>0;const D=y().subarray(Q+i,Q+B),c=f(A,D);i+=c.written,Q=g(Q,B,i,1)>>>0}return w=i,Q}var F=null;function o(){return(F===null||F.buffer.detached===!0||F.buffer.detached===void 0&&F.buffer!==C.memory.buffer)&&(F=new DataView(C.memory.buffer)),F}function n(A){const I=C.__externref_table_alloc();return C.__wbindgen_export_4.set(I,A),I}function k(A,I){try{return A.apply(this,I)}catch(g){const B=n(g);C.__wbindgen_exn_store(B)}}function R(A){const I=typeof A;if(I=="number"||I=="boolean"||A==null)return`${A}`;if(I=="string")return`"${A}"`;if(I=="symbol"){const Q=A.description;return Q==null?"Symbol":`Symbol(${Q})`}if(I=="function"){const Q=A.name;return typeof Q=="string"&&Q.length>0?`Function(${Q})`:"Function"}if(Array.isArray(A)){const Q=A.length;let E="[";Q>0&&(E+=R(A[0]));for(let i=1;i<Q;i++)E+=", "+R(A[i]);return E+="]",E}const g=/\[object ([^\]]+)\]/.exec(toString.call(A));let B;if(g&&g.length>1)B=g[1];else return toString.call(A);if(B=="Object")try{return"Object("+JSON.stringify(A)+")"}catch{return"Object"}return A instanceof Error?`${A.name}: ${A.message}
${A.stack}`:B}var l=typeof TextDecoder>"u"?(0,module.require)("util").TextDecoder:TextDecoder,K=new l("utf-8",{ignoreBOM:!0,fatal:!0});K.decode();function N(A,I){return A=A>>>0,K.decode(y().subarray(A,A+I))}function s(A){return A==null}function r(A,I){const g=I(A.length*1,1)>>>0;return y().set(A,g/1),w=A.length,g}function G(A){const I=C.__wbindgen_export_4.get(A);return C.__externref_table_dealloc(A),I}function Z(A){let I,g;try{const E=C.compute_xorb_hash(A);var B=E[0],Q=E[1];if(E[3])throw B=0,Q=0,G(E[2]);return I=B,g=Q,N(B,Q)}finally{C.__wbindgen_free(I,g,1)}}function m(A){let I,g;try{const E=C.compute_file_hash(A);var B=E[0],Q=E[1];if(E[3])throw B=0,Q=0,G(E[2]);return I=B,g=Q,N(B,Q)}finally{C.__wbindgen_free(I,g,1)}}function X(A,I){const g=I(A.length*4,4)>>>0;for(let B=0;B<A.length;B++){const Q=n(A[B]);o().setUint32(g+4*B,Q,!0)}return w=A.length,g}function W(A){let I,g;try{const E=X(A,C.__wbindgen_malloc),i=w,D=C.compute_verification_hash(E,i);var B=D[0],Q=D[1];if(D[3])throw B=0,Q=0,G(D[2]);return I=B,g=Q,N(B,Q)}finally{C.__wbindgen_free(I,g,1)}}function V(A,I){let g,B;try{const i=h(A,C.__wbindgen_malloc,C.__wbindgen_realloc),D=w,c=h(I,C.__wbindgen_malloc,C.__wbindgen_realloc),d=w,a=C.compute_hmac(i,D,c,d);var Q=a[0],E=a[1];if(a[3])throw Q=0,E=0,G(a[2]);return g=Q,B=E,N(Q,E)}finally{C.__wbindgen_free(g,B,1)}}var L=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(A=>C.__wbg_chunker_free(A>>>0,1)),p=class{__destroy_into_raw(){const A=this.__wbg_ptr;return this.__wbg_ptr=0,L.unregister(this),A}free(){const A=this.__destroy_into_raw();C.__wbg_chunker_free(A,0)}constructor(A){const I=C.chunker_new(A);return this.__wbg_ptr=I>>>0,L.register(this,this.__wbg_ptr,this),this}add_data(A){const I=r(A,C.__wbindgen_malloc),g=w,B=C.chunker_add_data(this.__wbg_ptr,I,g);if(B[2])throw G(B[1]);return G(B[0])}finish(){const A=C.chunker_finish(this.__wbg_ptr);if(A[2])throw G(A[1]);return G(A[0])}};function x(A,I){const g=String(I),B=h(g,C.__wbindgen_malloc,C.__wbindgen_realloc),Q=w;o().setInt32(A+4*1,Q,!0),o().setInt32(A+4*0,B,!0)}function j(A){return A.buffer}function z(){return k(function(A,I){return A.call(I)},arguments)}function u(A){return A.done}function T(){return k(function(A,I){return Reflect.get(A,I)},arguments)}function v(A,I){return A[I>>>0]}function O(A,I){return A[I]}function _(A){let I;try{I=A instanceof ArrayBuffer}catch{I=!1}return I}function P(A){let I;try{I=A instanceof Uint8Array}catch{I=!1}return I}function $(A){return Array.isArray(A)}function AA(A){return Number.isSafeInteger(A)}function IA(){return Symbol.iterator}function gA(A){return A.length}function BA(A){return A.length}function QA(){return new Object}function CA(){return new Array}function EA(A){return new Uint8Array(A)}function iA(A){return A.next}function DA(){return k(function(A){return A.next()},arguments)}function wA(A,I,g){A[I>>>0]=g}function oA(A,I,g){A[I]=g}function GA(A,I,g){A.set(I,g>>>0)}function cA(A){return A.value}function NA(A){return+A}function FA(A){const I=A;return typeof I=="boolean"?I?1:0:2}function yA(A,I){const g=R(I),B=h(g,C.__wbindgen_malloc,C.__wbindgen_realloc),Q=w;o().setInt32(A+4*1,Q,!0),o().setInt32(A+4*0,B,!0)}function hA(A,I){return new Error(N(A,I))}function aA(A,I){return A in I}function YA(){const A=C.__wbindgen_export_4,I=A.grow(4);A.set(0,void 0),A.set(I+0,void 0),A.set(I+1,null),A.set(I+2,!0),A.set(I+3,!1)}function MA(A){return typeof A=="function"}function JA(A){const I=A;return typeof I=="object"&&I!==null}function RA(A){return A===void 0}function sA(A,I){return A==I}function UA(){return C.memory}function kA(A,I){const g=I,B=typeof g=="number"?g:void 0;o().setFloat64(A+8*1,s(B)?0:B,!0),o().setInt32(A+4*0,!s(B),!0)}function LA(A){return A}function SA(A,I){const g=I,B=typeof g=="string"?g:void 0;var Q=s(B)?0:h(B,C.__wbindgen_malloc,C.__wbindgen_realloc),E=w;o().setInt32(A+4*1,E,!0),o().setInt32(A+4*0,Q,!0)}function HA(A,I){return N(A,I)}function nA(A,I){throw new Error(N(A,I))}var U=atob(`
...
bXVsdGl2YWx1ZQ==
`.trim().replaceAll(`
`,"")),t=new Uint8Array(U.length);for(let A=0;A<U.length;A++)t[A]=U.charCodeAt(A);var J=null;async function KA(){if(J)return J;let A,I;J=new Promise((g,B)=>{A=g,I=B}),await Promise.resolve();try{const g=await WebAssembly.compile(t),B=Object.entries(WebAssembly.Module.imports(g).reduce((E,i)=>({...E,[i.module]:[...E[i.module]||[],i.name]}),{})).map(([E,i])=>({from:E,names:i})),Q=await WebAssembly.instantiate(g,{"./hf_xet_thin_wasm_bg.js":Object.fromEntries(B[0].names.map(E=>[E,S[E]]))});H(Q.exports),Q.exports.__wbindgen_start(),A()}catch(g){I(g)}}KA();export{p as Chunker,m as compute_file_hash,V as compute_hmac,W as compute_verification_hash,Z as compute_xorb_hash,KA as init};
